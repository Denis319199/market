...
public class JwtServiceException extends Exception {
  ...
  public static final String INVALID_REFRESH_TOKEN = "Provided refresh token is invalid";
  public static final String REFRESH_TOKEN_NUMBER_EXCEEDED = "Refresh token number exceeded";
